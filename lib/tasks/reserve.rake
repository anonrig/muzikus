namespace :reserve do
	...
	task :hangar => :environment do 
		...
		#1
			...
			TuesdayRes=Reservations.new(user_id: president_id,room_id: hangar_id,start_date: tuesday_start_date,end_date:tuesday_end_date,info:"Proje",hour:duration)
			TuesdayRes.save
		#2
			...
			WednesdayRes=Reservations.new(user_id: president_id,room_id:hangar_id,start_date: wednesday_start_date,end_date:wednesday_end_date,info:"Proje",hour:duration)
			WednesdayRes.save
		#3	
		...
		FridayRes=Reservations.new(user_id: president_id,room_id:hangar_id,start_date: friday_start_date,end_date:friday_end_date,info:"Proje",hour:duration)
		FridayRes.save	
			else
